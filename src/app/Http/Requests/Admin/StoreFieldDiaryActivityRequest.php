...
class StoreFieldDiaryActivityRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'ends_at.after_or_equal' => 'La fecha de cierre no puede ser anterior a la fecha de inicio.',
            'questions.required' => 'Debes agregar al menos una pregunta.',
            'questions.min' => 'Debes agregar al menos una pregunta.',
            'questions.*.question_text.required' => 'Cada pregunta debe tener un texto.',
            'questions.*.question_type.required' => 'Cada pregunta debe tener un tipo.',
        ];
    }
}