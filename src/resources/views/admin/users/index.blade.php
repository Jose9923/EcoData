    ...
    <section class="admin-card bg-white overflow-hidden">
        <div class="p-3 p-md-4">
            <table id="usersTable"
                ...
                data-info="false"
                data-empty="No hay usuarios registrados.">
                        ...
                        <td class="text-end">
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <form method="POST"
                                    ...
                                    data-text="Esta acción eliminará el usuario {{ $user->name }}. Si tiene información asociada, el sistema podría impedir la eliminación."
