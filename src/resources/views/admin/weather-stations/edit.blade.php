...
@section('title', 'Editar estación meteorológica')
...
@section('content')
    <section class="admin-hero p-4 p-md-5">
        <div class="row g-3 align-items-center">
            <div class="col-12 col-lg-8">
                ...
                <h1 class="display-6 fw-bold mb-2">Editar estación meteorológica</h1>
                <p class="mb-0 text-light-emphasis">
                    Actualiza la información de {{ $station->name }}.
                </p>
            </div>
    ...
    <section class="admin-card bg-white p-4">
        <form method="POST" action="{{ route('admin.weather-stations.update', $station) }}">
            @csrf
            @method('PUT')
