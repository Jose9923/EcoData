<div class="space-y-6">
    ...
    <section class="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
        <div class="grid gap-4 lg:grid-cols-[1fr_auto]">
            <div>
                <label for="grade-search" class="mb-2 block text-sm font-semibold text-slate-700">
                    Buscar grado
                </label>
                        ...
                        <tr class="transition hover:bg-slate-50/70">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <button
                                        type="button"
                                        onclick="confirm('¿Seguro que deseas eliminar este grado?') || event.stopImmediatePropagation()"
                                ...
                                <div class="mx-auto max-w-md">
                                    <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-slate-100 text-slate-400">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.7" d="M12 6v12m6-6H6" />
                                        </svg>
                                    </div>
                                    ...
                                    <p class="mt-1 text-sm text-slate-500">
                                        @if ($search !== '')
                                            Ajusta el término de búsqueda o limpia el filtro para ver todos los grados.
                                        @else
                                            Crea el primer grado para comenzar a estructurar la asignación académica.
                                        @endif
                                    </p>
                                </div>
                            </td>
                ...
                <div class="relative z-10 w-full max-w-4xl rounded-3xl bg-white shadow-2xl">
                    <div class="flex items-start justify-between border-b border-slate-200 px-6 py-5">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-slate-500">
                                Configura el grado, su etiqueta visible y el colegio al que pertenece.
                            </p>
                        </div>
                    ...
                    <form wire:submit.prevent="save" class="space-y-6 px-6 py-6">
                        ...
                        <div class="grid gap-6 md:grid-cols-2">
                            <div>
                                <label class="mb-2 block text-sm font-semibold text-slate-700">
                                    Nombre del grado <span class="text-rose-500">*</span>
                                </label>
                                <input
                                    type="text"
                        ...
                        <div class="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
                            <div class="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                                ...
                                <div class="mt-4 space-y-3 text-sm text-slate-600">
                                    <p>
                                        El nombre del grado debe ser único dentro del mismo colegio.
                                    </p>
                                    <p>
                                        La etiqueta visible es opcional y te permite mostrar una forma más legible, por ejemplo “Sexto”.
                                    </p>
                                    <p>
                                        Si el grado se marca como inactivo, seguirá existiendo en el sistema pero no debería usarse para nuevas asignaciones.
                                    </p>
                                </div>
                            </div>
